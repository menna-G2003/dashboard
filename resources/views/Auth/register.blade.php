      ...
      <div class="auth-box border-top border-secondary">
        <div id="loginform">
          ...
          <form
            ...
            id="loginform"
            action="{{route('Auth.handleRegster')}}"
            method="post">
            @csrf
            <div class="row pb-4">
              <div class="col-12">
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="form-check">
                    <input type="radio" class="form-check-input" id="User" name="Admin" value="User" required>
                    <label class="form-check-label" for="User">User</label>
                  </div>
                  <br>
                  <div class="form-check">
                    <input type="radio" class="form-check-input" id="Admin" name="Admin" value="Admin">
